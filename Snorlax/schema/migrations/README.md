...
| --- | --- |
| `python run_sql.py --reset --build` | **Drop everything, then recreate the schema** (00_config.sql + 01_schema.sql). |
...
| `python run_sql.py ../00_config.sql ../01_schema.sql` | Run specific file(s) in order. |
